...
import animation_lm1qwfmu from "../LottieFiles/animation_lm1qwfmu.json";
    ...
    <div >
      <div className='HomePage'>
        ...
        <div className='HomeText'>
          <h1>Hi There!</h1>
          <h1>I'M <b>ADARSH KUMAR</b></h1>
          <Typed/>   
        </div>

        <Lottie 
          className="illustration" 
          animationData={animation_lm1qwfmu} 
          loop={true} 
        />
        {/* <Lottie 
          className="illustration" 
          animationData={animation_lm1r6yyx} 
          loop={true} 
        /> */}
